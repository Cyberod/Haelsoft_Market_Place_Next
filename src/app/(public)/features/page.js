    ...
    <section id="Home" className="max-w-full pt-6 sm:pt-8 md:pt-10 lg:pt-12">
      ...
      <div className="sm:px-5 lg:px-[100px] xl:px-[180px] 2xl:px-[260px] tracking-[0px] frame">
        <div className="flex flex-col justify-center items-center text-center">
          ...
          <p className="text-[32px] sm:text-[33px] md:text-[38px] lg:text-[48px] font-bold lg:leading-17.5 leading-10 xl:px-[100px]">Powerful Features to Help you <span className="bg-[#2E6E6E] text-white px-6 py-[3px] rounded-xl">Sell</span></p>
